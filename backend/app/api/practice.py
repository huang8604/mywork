...
def get_session_item_audio(
    ...
    if language == "zh":
        audio = generate_chinese_audio(item.snapshot_cn_meaning)
        return FileResponse(
            audio,
...
def get_number_audio(
    ...
    Both languages are pre-generated by ``POST /words/audio/generate-numbers``.
    A missing Chinese clip is also generated and cached on authenticated playback.
    """
