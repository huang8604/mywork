...
REQUIRED_SCOPES: dict[tuple[str, str], list[str]] = {
    ...
    ("GET", "/api/v1/words/import/progress"): ["words:read"],
    ("POST", "/api/v1/words/batch/delete"): ["words:write"],
    ("POST", "/api/v1/words/batch/tags"): ["words:write"],
    ("POST", "/api/v1/words/batch/audio"): ["words:write"],
    ("POST", "/api/v1/words/batch/reset-progress"): ["words:write"],
    ...
    (
        "GET",
        "/api/v1/practice-sessions/{session_id}/items/{item_id}/audio",
    ): ["practice:read"],
    ("PATCH", "/api/v1/practice-sessions/{session_id}"): ["practice:write"],
    ("PUT", "/api/v1/practice-sessions/{session_id}/items"): ["practice:write"],
