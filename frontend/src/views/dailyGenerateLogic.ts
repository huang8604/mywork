/** Split a blob of words on newlines / latin & CJK commas / semicolons;
 ...
 *  Spaces are deliberately preserved so a phrase such as "look forward to" stays
 *  one entry. Users can still write "camera, focus" on a single line. */
