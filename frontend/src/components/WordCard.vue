...
defineEmits<{ edit: []; remove: []; reset: []; review: [] }>()
...
<template>
  <article class="word-card">
    ...
    <div class="card-actions"><el-button @click="$emit('review')">复习</el-button><el-button @click="$emit('edit')">编辑</el-button><el-button @click="$emit('reset')">设为新词</el-button><el-button type="danger" plain @click="$emit('remove')">删除</el-button></div>
  </article>
</template>
