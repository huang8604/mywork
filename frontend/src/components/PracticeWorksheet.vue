...
const fontPoints: Record<WorksheetFontSize, number> = { small: 9, medium: 10.5, large: 12 }
const wordFontPoints: Record<WorksheetFontSize, number> = { small: 12, medium: 14, large: 16 }
