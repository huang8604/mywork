...
<template>
  <section class="worksheet" :aria-label="title">
    ...
    <table class="worksheet-table">
      <colgroup><col class="number-col"><col class="word-col"><col class="meaning-col"><col class="example-col"></colgroup>
      ...
      <tbody><tr v-for="item in session.items" :key="item.item_id"><td class="number-cell">{{ item.position }}</td><td class="word-cell">{{ wordCell(item) }}</td><td class="meaning-cell">{{ chinese(item) }}</td><td class="example-cell">{{ example(item) }}</td></tr></tbody>
    </table>
